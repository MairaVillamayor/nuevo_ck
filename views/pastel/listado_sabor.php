...
$pdo = getConexion();
$query = "SELECT s.id_sabor, s.sabor_nombre, s.sabor_descripcion, e.estado_decoraciones_descri 
        FROM sabor s
        JOIN estado_decoraciones e ON s.RELA_estado_decoraciones = e.ID_estado_decoraciones";
