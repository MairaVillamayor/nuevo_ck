...
// Si ya existe una caja abierta, evitamos abrir otra
$caja = new Caja();
...
if ($caja_abierta) {
    ...
    <div class='container mt-4'>
        <div class='alert alert-warning text-center' style='font-size:1.1rem; background-color:#fff3cd; color:#856404; border:1px solid #ffeeba; border-radius:10px;'>
            ⚠️ Ya existe una caja abierta.<br>
            <a href='listado_caja.php' class='btn btn-rosa mt-3' style='background-color:#ff66b2; color:white; border:none; border-radius:8px; padding:8px 16px;'>Volver al listado</a>
        </div>
    </div>";
    exit;
}
  ...
  <div class="card shadow-lg p-4 rounded-4">
    ...
    <form id="form_caja" method="POST" action="../../controllers/caja/caja_controlador.php">
      ...
      <div class="row">
        <div class="col-md-6 mb-3">
          ...
          <div class="input-group">
            ...
            <input type="number" step="0.01" min="0" class="form-control" id="monto_inicial_efectivo" name="monto_inicial_efectivo" required>
          </div>
        </div>
        ...
        <div class="col-md-6 mb-3">
          ...
          <div class="input-group">
            <span class="input-group-text">$</span>
            <input type="number" step="0.01" min="0" class="form-control" id="monto_inicial_transferencia" name="monto_inicial_transferencia" required>
          </div>
        </div>
      </div>
      ...
      <div class="mb-3">
        ...
        <textarea class="form-control" id="observaciones" name="observaciones" rows="3" placeholder="Notas sobre la apertura de la caja..."></textarea>
      </div>
