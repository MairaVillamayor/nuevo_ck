...
$historial_cajas = $cajaController->obtenerCajasUsuario($_SESSION['usuario_id'], 100);
...
if ($fecha_inicio || $fecha_fin || $estado_filtro) {
    $historial_cajas = array_filter($historial_cajas, function($caja) use ($fecha_inicio, $fecha_fin, $estado_filtro) {
        ...
        return $match_fecha_inicio && $match_fecha_fin && $match_estado;
    });
}
?>
...
<head>
    ...
    <title>Historial de Cajas - Cake Party</title>
...
<body>
    <div class="dashboard-container">
        ...
        <div class="sidebar" id="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <a href="historial_cajas.php" class="nav-item active">
                    <i>📋</i> Historial
                </a>
                <?php if (in_array($_SESSION['perfil_id'], [1, 4])): ?>
        ...
        <div class="main-content" id="mainContent">
            ...
            <div class="content-header">
                ...
                <p class="content-subtitle">Consulta el historial completo de tus cajas</p>
            </div>
            ...
            <div class="table-container">
                <div class="table-header">
                    <h3 class="table-title">📊 Historial de Cajas</h3>
                    <div class="table-count"><?= count($historial_cajas) ?> registros</div>
                </div>
                <table>
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <?php if (empty($historial_cajas)): ?>
                            <tr>
                                <td colspan="9" class="no-data">No hay cajas registradas</td>
                            </tr>
                        <?php else: ?>
    ...
    <script>
        ...
        function limpiarFiltros() {
            ...
            window.location.href = 'historial_cajas.php';
        }
